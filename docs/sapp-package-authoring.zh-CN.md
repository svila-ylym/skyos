...
- `Depends` 和兼容判断必须使用内部版本，例如 `base-tools (>= 10002)`。
...
```sh
python spk.py inspect repo/pool/main/hello_1.0.1.0.SKYCNQU_skyos-i386.spk
```
...
- 依赖版本写了 `1.0.1.0.SKYCNQU`：改成内部版本，例如 `10002`。

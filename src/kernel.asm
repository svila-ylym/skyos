...
os_version db 'SkyOS 1.0.1.0.SKYCNQU', 0
os_internal_version db '10002', 0
...
skyfs_file_os_release db 'NAME=SkyOS', 10, 'VERSION=1.0.1.0.SKYCNQU', 10, 'VERSION_ID=1.0.1.0.SKYCNQU', 10, 'BUILD_ID=10002', 10, 'ID=skyos', 10, 'ARCH=i386', 10, 'ROOTFS=skyfs', 10, 0
...
ssh_server_banner db 'SSH-2.0-SkyOS_1.0.1.0.SKYCNQU', 13, 10, 0
...
msg_sapp_version db '1.0.1.0.SKYCNQU', 0
msg_sapp_internal db '10002', 0
msg_sapp_dep_none db 0
msg_sapp_dep_base_internal db 'base-tools (>= 10002)', 0
msg_sapp_dep_base_net_internal db 'base-tools (>= 10002), net-tools (>= 10002)', 0
msg_sapp_file_1 db 'pool/main/base-tools_1.0.1.0.SKYCNQU_skyos-i386.spk', 0
msg_sapp_file_2 db 'pool/main/net-tools_1.0.1.0.SKYCNQU_skyos-i386.spk', 0
msg_sapp_file_3 db 'pool/main/editor-vi_1.0.1.0.SKYCNQU_skyos-i386.spk', 0
msg_sapp_file_4 db 'pool/main/sapp-utils_1.0.1.0.SKYCNQU_skyos-i386.spk', 0
msg_sapp_file_5 db 'pool/main/calc_1.0.1.0.SKYCNQU_skyos-i386.spk', 0
msg_sapp_file_6 db 'pool/main/skycrt_1.0.1.0.SKYCNQU_skyos-i386.sxr', 0
msg_sapp_file_7 db 'pool/main/skyui_1.0.1.0.SKYCNQU_skyos-i386.sxr', 0
msg_sapp_size_1 db '318', 0
msg_sapp_size_2 db '342', 0
msg_sapp_size_3 db '339', 0
msg_sapp_size_4 db '369', 0
msg_sapp_size_5 db '304', 0
msg_sapp_size_6 db '256', 0
msg_sapp_size_7 db '288', 0
...
msg_sapp_pkg_1 db 'base-tools/skyos 1.0.1.0.SKYCNQU i386 spk-binary-v1', 0
msg_sapp_pkg_2 db 'net-tools/skyos 1.0.1.0.SKYCNQU i386 spk-binary-v1 depends=base-tools (>= 10002)', 0
msg_sapp_pkg_3 db 'editor-vi/skyos 1.0.1.0.SKYCNQU i386 spk-binary-v1 depends=base-tools (>= 10002)', 0
msg_sapp_pkg_4 db 'sapp-utils/skyos 1.0.1.0.SKYCNQU i386 spk-binary-v1 depends=base-tools (>= 10002), net-tools (>= 10002)', 0
...
msg_sapp_calc_sxr db '  SXR-Depends: skycrt (>= 10002)', 0
...
msg_uname db 'SkyOS SKY-86 1.0.1.0.SKYCNQU i386 sky-kernel', 0
...
msg_feature_fs db 'filesystem: RAMFS fixed inode table, MBR raw disk sector I/O; ext4/FAT32/NTFS pending', 0
...
msg_fsinfo_3 db 'disk fs: MBR partition inspect/write plus signature probe for ext/FAT/NTFS/SkyFS', 0
...
logo_png_end:
home_title db 'Welcome to SkyOS 1.0.1.0.SKYCNQU (sky-kernel 10002 i386)', 0
...
boot_banner db 'SkyOS 1.0.1.0.SKYCNQU x86', 0
boot_ok db '[ OK ] ', 0
...
shell_loop:
    cmp byte [gui_autostart_done], 1
    je .prompt
    mov byte [gui_autostart_done], 1
...
.task_x_store:
    ...
    mov dword [gui_winw + GUI_WIN_TASK * 4], 360
    mov dword [gui_winh + GUI_WIN_TASK * 4], 220
...
.drag_y_min_ok:
    mov ebx, [fb_height]
    sub ebx, GUI_TASKBAR_H + GUI_TITLE_H
    cmp ebx, 0
    jge .drag_y_max_ok
    xor ebx, ebx
.drag_y_max_ok:
